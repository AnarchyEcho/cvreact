...
export default function About() {
    ...
    return (
        <div>
            ...
            <h3>Skills: </h3>
            <p>I know how to code in React, React Native, HTML, CSS, JavaScript, and to some extent: Lua, Python, Java and C#, as i have used them for various game related uses such as mods and addons.</p>
            <h3>School: </h3>
