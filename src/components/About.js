...
export default function About() {
    ...
    return (
        <AboutWrapper>
            ...
            <p>Including coding in React, React Native, HTML, CSS, JavaScript, i also know to some extent: Lua, Python, Java and C#, as I have used them for various game related uses such as mods and addons. I'd say I have a preference for Back-end. I've also recently got into MERN stack development.</p>
